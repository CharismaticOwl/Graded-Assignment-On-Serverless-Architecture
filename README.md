...
1. Created two ec2 instances with tag - tag:Auto-Start and tag:Auto-Stop
2. Made Sure that the instances are running
3. Navigated to IAM, created a role, and attached `AmazonEc2FullAccess`
...
7. The function is stopping the ec2 instance with tag `Auto-Stop` and starting the instances with tag `Auto-Start`
